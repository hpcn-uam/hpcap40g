...
#endif
#ifdef DEV_HPCAP
	I40EVF_STAT("rx_hpcap_client_lost_frames", hpcap_client_loss),
	I40EVF_STAT("rx_hpcap_noclient_frames", hpcap_client_discard),
#ifdef REMOVE_DUPS
	I40EVF_STAT("rx_hpcap_dup_frames", total_dup_frames)
#endif
#endif
};
