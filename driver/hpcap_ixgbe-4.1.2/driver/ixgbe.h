 ...
 * @param iph  IP header without options
 * @param tcp  TCP header
 * @param ts   Optional TCP timestamp data in TCP options
 *
...
#define IXGBE_FLAG_RSS_ENABLED                  (u32)(1 << 28)
#define IXGBE_FLAG_RSS_CAPABLE                  (u32)(1 << 29)
...
bool ixgbe_clean_tx_irq_standard(struct ixgbe_q_vector *q_vector, struct ixgbe_ring *tx_ring);
void ixgbe_alloc_rx_buffers_hpcap(struct ixgbe_ring *rx_ring, u16 cleaned_count);
