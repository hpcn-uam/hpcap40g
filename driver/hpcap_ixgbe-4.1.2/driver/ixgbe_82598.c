 ...
 * @param hw  pointer to hardware structure
 * @param speed  pointer to link speed
 * @param link_up  true is link is up, false otherwise
 ...
 * @param hw  pointer to hardware struct
 * @param rar  receive address register index to associate with a VMDq index
 * @param vmdq  VMDq clear index (not used in 82598, but elsewhere)
 **/
STATIC s32 ixgbe_clear_vmdq_82598(struct ixgbe_hw *hw, u32 rar, u32 vmdq)
{
	u32 rar_high;
 ...
 * @param hw  pointer to hardware structure
 * @param dev_addr  address to read from
 * @param byte_offset  byte offset to read from dev_addr
