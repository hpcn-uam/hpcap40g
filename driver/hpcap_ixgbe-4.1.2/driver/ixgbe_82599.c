 ...
 * @param hw  pointer to hardware structure
 * @param locked  Return the if we locked for this read.
 ...
 * @param hw  pointer to hardware structure
 * @param speed  new link speed
 * @param autoneg_wait_to_complete  true if waiting is needed to complete
 *
 ...
 * @param hw  pointer to hardware structure
 * @param fdircmd  current value of FDIRCMD register
 */
 ...
 * @param hw  pointer to hardware structure
 * @param fdirctrl  value to write to flow director control register
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param fdirctrl  value to write to flow director control register, initially
 ...
 * @param fdirctrl  value to write to flow director control register, initially
 *	     contains just the value of the Rx packet buffer allocation
 * @param cloud_mode  true - cloud mode, false - other mode
 **/
 ...
 * @param stream  input bitstream to compute the hash on
 *
 ...
 * @param hw  pointer to hardware structure
 * @param input  unique input dword
 * @param common  compressed common input dword
 * @param queue  queue index to direct traffic to
 *
 ...
 * @param atr_input  input bitstream to compute the hash on
 * @param input_mask  mask for the input bitstream
 *
 ...
 * @param input_mask  mask to be bit swapped
 *
 ...
 * @param input_mask  mask for the input bitstream
 * @param soft_id  software index for the filters
 * @param queue  queue index to direct traffic to
 *
 ...
 * @param hw  pointer to hardware structure
 * @param reg  atlas register to write
 ...
 *
 * @param hw  pointer to hardware structure
 * @param offset  offset of  word in EEPROM to read
