 ...
 * @param hw  pointer to hardware structure
 * @param device_caps  the EEPROM word for device capabilities
 *
 ...
 * @param hw  pointer to hardware structure
 * @param firmware_version  pointer to firmware version
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param reg_addr  32 bit address of PHY register to read
 * @param phy_data  Pointer to read data from PHY register
 *
 ...
 * @param hw  pointer to hardware structure
 * @param reg_addr  32 bit PHY register to write
 * @param phy_data  Data to write to the PHY register
 *
 ...
 * @param hw  pointer to hardware structure
 * @param rar  receive address register index to associate with VMDq index
 ...
 * @param hw  pointer to hardware structure
 * @param vmdq  VMDq default pool index
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param rar  receive address register index to disassociate with VMDq index
 * @param vmdq  VMDq set or pool index
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param addr_list  the list of new multicast addresses
 * @param addr_count  number of addresses
 * @param func  iterator function to walk the multicast address list
 *
 ...
 * @param vind  VMDq output index that maps queue to VLAN id in VFTA
 * @param vlan_on  boolean flag to turn on/off VLAN in VFTA
 *
 ...
 * @param hw  pointer to hardware structure
 * @param maj  driver major number to be sent to firmware
 * @param min  driver minor number to be sent to firmware
 * @param build  driver build number to be sent to firmware
 * @param ver  driver version number to be sent to firmware
 **/
 ...
 * @param hw  pointer to the HW structure
 * @param enable_eee  boolean flag to enable EEE
 *
 ...
 * @param hw  pointer to hardware structure
 * @param enbale  enable or disable source address pruning
 * @param pool  Rx pool - Rx pool to toggle source address pruning
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param enable  enable or disable switch for Ethertype anti-spoofing
 * @param vf  Virtual Function pool - VF Pool to set for Ethertype anti-spoofing
 *
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param reg_addr  32 bit address of PHY register to read
 * @param device_type  type of device you want to communicate with
 * @param phy_data  Pointer to read data from PHY register
 *
 *  Reads a value from a specified PHY register
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param vf_bitmap  vf bitmap of malicious vfs
 *
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param reg  analog register to read
 ...
 * @param hw  pointer to hardware structure
 * @param reg  analog register to write
 ...
 * @param hw  pointer to hardware structure
 * @param byte_offset  byte offset to read
 * @param dev_addr  I2C bus address to read from
 ...
 * @param addr  I2C bus address to read from
 * @param reg  I2C device register to read from
 * @param val  pointer to location to receive read value
 *
 ...
 * @param hw  pointer to hardware structure
 * @param byte_offset  byte offset to write
 * @param dev_addr  I2C bus address to write to
 ...
 * @param hw  pointer to the hardware structure
 * @param addr  I2C bus address to write to
 ...
 * @param hw  pointer to hardware structure
 * @param byte_offset  EEPROM byte offset to write
 * @param eeprom_data  value to write
 *
 *  Performs byte write operation to SFP module's EEPROM over I2C interface.
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param byte_offset  EEPROM byte offset to read
 * @param eeprom_data  value read
 *
 *  Performs byte read operation to SFP module's EEPROM over I2C interface.
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param regval  bitfield to write to the Rx DMA register
 *
