 ...
 * @param hw  pointer to hardware structure
 * @param pba_num  stores the part number string from the EEPROM
 * @param pba_num_size  part number string buffer length
 *
 ...
 * @param hw  pointer to hardware structure
 * @param mac_addr  Adapter MAC address
 *
 ...
 * @param hw  pointer to hardware structure
 * @param link_status  the link status returned by the PCI config space
 *
 ...
 * @param hw  pointer to hardware structure
 * @param index  led number to turn on
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param index  led number to turn off
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param offset  offset within the EEPROM to write
 * @param words  number of word(s)
 * @param data  16 bit word(s) to write to EEPROM
 *
 ...
 * @param hw  pointer to hardware structure
 * @param offset  offset within the EEPROM to be written to
 * @param words  number of word(s)
 * @param data  16 bit word(s) to be written to the EEPROM
 *
 ...
 * @param hw  pointer to hardware structure
 * @param offset  offset within the EEPROM to be written to
 * @param data  16 bit word to be written to the EEPROM
 *
 *  If ixgbe_eeprom_update_checksum is not called after this function, the
 *  EEPROM will most likely contain an invalid checksum.
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param offset  offset within the EEPROM to be read
 * @param data  read 16 bit words(s) from EEPROM
 * @param words  number of word(s)
 *
 *  Reads 16 bit word(s) from EEPROM through bit-bang method
 **/
 ...
 * @param offset  offset within the EEPROM to be read
 * @param words  number of word(s)
 * @param data  read 16 bit word(s) from EEPROM
 *
 *  Reads 16 bit word(s) from EEPROM through bit-bang method
 **/
STATIC s32 ixgbe_read_eeprom_buffer_bit_bang(struct ixgbe_hw *hw, u16 offset,
 ...
 * @param hw  pointer to hardware structure
 * @param offset  offset within the EEPROM to be read
 * @param data  read 16 bit value from EEPROM
 *
 ...
 * @param hw  pointer to hardware structure
 * @param offset  offset of word in the EEPROM to read
 * @param words  number of word(s)
 * @param data  16 bit word(s) from the EEPROM
 *
 ...
 * @param hw  pointer to hardware structure
 * @param offset  offset within the EEPROM to be used as a scratch pad
 *
 ...
 * @param hw  pointer to hardware structure
 * @param offset  offset of  word in the EEPROM to read
 * @param data  word read from the EEPROM
 *
 ...
 * @param hw  pointer to hardware structure
 * @param offset  offset of  word in the EEPROM to write
 * @param words  number of word(s)
 * @param data  word(s) write to the EEPROM
 *
 ...
 * @param hw  pointer to hardware structure
 * @param offset  offset of  word in the EEPROM to write
 * @param data  word write to the EEPROM
 *
 ...
 * @param hw  pointer to hardware structure
 * @param ee_reg  EEPROM flag for polling
 *
 ...
 * @param hw  pointer to hardware structure
 * @param data  data to send to the EEPROM
 * @param count  number of bits to shift out
 **/
STATIC void ixgbe_shift_out_eeprom_bits(struct ixgbe_hw *hw, u16 data,
										u16 count)
{
 ...
 * @param hw  pointer to hardware structure
 * @param eec  EEC register's current value
 **/
STATIC void ixgbe_raise_eeprom_clk(struct ixgbe_hw *hw, u32 *eec)
{
 ...
 * @param hw  pointer to hardware structure
 * @param eecd  EECD's current value
 **/
STATIC void ixgbe_lower_eeprom_clk(struct ixgbe_hw *hw, u32 *eec)
{
 ...
 * @param hw  pointer to hardware structure
 * @param checksum_val  calculated checksum
 *
 ...
 * @param vmdq  VMDq "set" or "pool" index
 * @param enable_addr  set flag that address is active
 *
 ...
 * @param hw  pointer to hardware structure
 * @param addr_list  the list of new addresses
 * @param addr_count  number of addresses
 * @param next  iterator function to walk the address list
 *
 ...
 * @param hw  pointer to hardware structure
 * @param mc_addr  the multicast address
 *
 ...
 * @param hw  pointer to hardware structure
 * @param hash_value  Multicast address hash value
 *
 ...
 * @param hw  pointer to hardware structure
 * @param mc_addr_list  the list of new multicast addresses
 * @param mc_addr_count  number of addresses
 * @param next  iterator function to walk the multicast address list
 * @param clear  flag, when set clears the table beforehand
 *
 ...
 * @param hw  pointer to hardware structure
 * @param adv_reg  flow control advertised settings
 * @param lp_reg  link partner's flow control settings
 * @param adv_sym  symmetric pause bit in advertisement
 * @param adv_asm  asymmetric pause bit in advertisement
 * @param lp_sym  symmetric pause bit in link partner advertisement
 * @param lp_asm  asymmetric pause bit in link partner advertisement
 *
 ...
 * @param hw  pointer to hardware structure
 * @param mask  Mask to specify which semaphore to acquire
 *
 ...
 * @param hw  pointer to hardware structure
 * @param mask  Mask to specify which semaphore to release
 *
 ...
 * @param hw  pointer to hardware structure
 * @param reg_val  Value we read from AUTOC
 *
 ...
 * @param hw  pointer to hardware structure
 * @param reg_val  value to write to AUTOC
 * @param locked  bool to indicate whether the SW/FW lock was already taken by
 *           previous read.
 *
 ...
 * @param hw  pointer to hardware structure
 * @param regval  register value to write to RXCTRL
 *
 ...
 * @param hw  pointer to hardware structure
 * @param index  led number to blink
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param index  led number to stop blinking
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param san_mac_offset  SAN MAC address offset
 *
 ...
 * @param hw  pointer to hardware structure
 * @param san_mac_addr  SAN MAC address
 *
 ...
 * @param hw  pointer to hardware structure
 * @param addr  Address to put into receive address register
 * @param vmdq  VMDq pool to assign
 *
 ...
 * @param rar  receive address register index to disassociate
 * @param vmdq  VMDq pool index to remove from the rar
 **/
 ...
 * @param hw  pointer to hardware struct
 * @param rar  receive address register index to associate with a VMDq index
 * @param vmdq  VMDq pool index
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param vlan  VLAN id to write to VLAN filter
 *
 ...
 * @param hw  pointer to hardware structure
 * @param vlan  VLAN id to write to VLAN filter
 * @param vind  VMDq output index that maps queue to VLAN id in VFVFB
 * @param vlan_on  boolean flag to turn on/off VLAN in VFVF
 *
 ...
 * @param vind  VMDq output index that maps queue to VLAN id in VFVFB
 * @param vlan_on  boolean flag to turn on/off VLAN in VFVF
 * @param vfta_changed  pointer to boolean flag which indicates whether VFTA
 *                 should be changed
 *
 ...
 * @param hw  pointer to hardware structure
 * @param speed  pointer to link speed
 * @param link_up  true when link is up
 * @param link_up_wait_to_complete  bool used to wait for link up or not
 *
 ...
 *  the EEPROM
 * @param hw  pointer to hardware structure
 * @param wwnn_prefix  the alternative WWNN prefix
 * @param wwpn_prefix  the alternative WWPN prefix
 *
 ...
 * @param hw  pointer to hardware structure
 * @param enable  enable or disable switch for anti-spoofing
 * @param pf  Physical Function pool - do not enable anti-spoofing for the PF
 *
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param enable  enable or disable switch for VLAN anti-spoofing
 * @param vf  Virtual Function pool - VF Pool to set for VLAN anti-spoofing
 *
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param device_caps  the EEPROM word with the extra device capabilities
 *
 ...
 * @param buffer  pointer to EEPROM
 * @param length  size of EEPROM to calculate a checksum for
 ...
 * @param hw  pointer to the HW structure
 * @param buffer  contains the command to write and where the return status will
 *   be placed
 * @param length  length of buffer, must be multiple of 4 bytes
 * @param timeout  time in ms to wait for command completion
 * @param return_data  read and return data from the buffer (true) or not (false)
 ...
 * @param hw  pointer to the HW structure
 * @param maj  driver version major number
 * @param min  driver version minor number
 * @param build  driver version build number
 * @param sub  driver version sub build number
 *
 ...
 * @param hw  pointer to hardware structure
 * @param num_pb  number of packet buffers to allocate
 * @param headroom  reserve n KB of headroom
 * @param strategy  packet buffer allocation strategy
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param data  pointer to the thermal sensor data structure
 *
 ...
 * @param hw  pointer to hardware structure
 * @param map  pointer to u8 arr for returning map
 *
 ...
 * @param hw  pointer to hardware structure
 * @param speed  new link speed
 * @param autoneg_wait_to_complete  true when waiting for completion is needed
 *
