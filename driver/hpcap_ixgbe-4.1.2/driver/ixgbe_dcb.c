 ...
 * @param ixgbe_dcb_config  Struct containing DCB settings.
 * @param direction  Configuring either Tx or Rx.
 *
 ...
 * @param cfg  dcb configuration to unpack into hardware consumable fields
 * @param map  user priority to traffic class map
 * @param pfc_up  u8 to store user priority PFC bitmask
 *
 ...
 * @param dcb_config  Pointer to DCB config structure
 *
 ...
 * @param tc_count   Number of elements in bwg_array.
 *
 ...
 * @param hw  pointer to hardware structure
 * @param dcb_config  pointer to ixgbe_dcb_config structure
 *
