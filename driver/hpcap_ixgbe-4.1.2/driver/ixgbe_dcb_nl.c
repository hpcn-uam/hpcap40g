 ...
 * @param idtype  : identifies the id as ether type or TCP/UDP port number
 * @param id  id is either ether type or TCP/UDP port number
 *
 ...
 * @param idtype  : identifies the id as ether type or TCP/UDP port number
 * @param id  id is either ether type or TCP/UDP port number
 * @param up  the 802.1p user priority bitmap
 *
