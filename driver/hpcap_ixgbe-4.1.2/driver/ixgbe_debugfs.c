 ...
 * @param filp  the opened file
 * @param buffer  where to write the data for the user to read
 * @param count  the size of the user's buffer
 * @param ppos  file position offset
 **/
 ...
 * @param filp  the opened file
 * @param buffer  where to find the user's data
 * @param count  the length of the user's data
 * @param ppos  file position offset
 **/
 ...
 * @param adapter  the adapter that is starting up
 **/
 ...
 * @param pf  the pf that is stopping
 **/
