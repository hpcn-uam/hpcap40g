 ...
 * @param ddp  - ptr to the ixgbe_fcoe_ddp
 *
 * Returns : none
 *
 */
 ...
 * @param netdev  the corresponding net_device
 * @param xid  the xid that corresponding ddp will be freed
 *
 ...
 * @param netdev  the corresponding net_device
 * @param xid  the exchange id requesting ddp
 * @param sgl  the scatter-gather list for this request
 * @param sgc  the number of scatter-gather items
 *
 ...
 * @param adapter  ixgbe adapter
 * @param rx_desc  advanced rx descriptor
 * @param skb  the skb holding the received data
 *
 ...
 * @param tx_ring  tx desc ring
 * @param first  first tx_buffer structure containing skb, tx_flags, and protocol
 * @param hdr_len  hdr_len to be returned
 *
 ...
 * @param adapter  ptr to ixgbe adapter
 *
 ...
 * @param netdev  the corresponding netdev
 *
 ...
 * @param netdev  : ixgbe adapter
 * @param wwn  : the world wide name
 * @param type  the type of world wide name
 *
