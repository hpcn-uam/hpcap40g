 ...
 * @param hw  pointer to the hardware structure
 * @param byte  pointer to a u8 to receive the byte
 *
 * Returns an error code on error.
 */
 ...
 * @param lock  true if to take and release semaphore
 *
 * Returns an error code on error.
 */
 ...
 * @param device_type  5 bit device type
 ...
 * @param autoneg  boolean auto-negotiation value
 *
 ...
 * @param hw  pointer to hardware structure
 * @param firmware_version  pointer to the PHY Firmware Version
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param list_offset  offset to the SFP ID list
 * @param data_offset  offset to the SFP data block
 *
 ...
 * @param hw  pointer to hardware structure
 * @param byte_offset  byte offset at address 0xA2
 * @param eeprom_data  value read
 *
 ...
 * @param hw  pointer to hardware structure
 * @param offset  eeprom offset to be read
 * @param addr  I2C address to be read
 */
 ...
 * @param hw  pointer to hardware structure
 * @param data  data byte to clock in
 *
 ...
 * @param hw  pointer to hardware structure
 * @param data  data byte clocked out
 *
 ...
 * @param hw  pointer to hardware structure
 * @param i2cctl  Current value of I2CCTL register
 *
 ...
 * @param hw  pointer to hardware structure
 * @param i2cctl  Current value of I2CCTL register
 * @param data  I2C data value (0 or 1) to set
 *
