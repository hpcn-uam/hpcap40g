 ...
 * @param hw_cc  cyclecounter structure
 *
 ...
 * @param hw_cc  the cyclecounter structure
 *
 ...
 * @param adapter  private adapter structure
 * @param hwtstamp  stack timestamp structure
 * @param systim  unsigned 64bit system time value
 *
 ...
 * @param ptp  the ptp clock structure
 * @param ppb  parts per billion adjustment from base
 *
 ...
 * @param ptp  the ptp clock structure
 * @param delta  offset to adjust the cycle counter by
 *
 ...
 * @param ptp  the ptp clock structure
 * @param ts  timespec64 structure to hold the current time value
 *
 ...
 * @param ptp  the ptp clock structure
 * @param ts  the timespec64 containing the new time for the cycle counter
 *
 ...
 * @param ptp  the ptp clock structure
 * @param rq  the requested feature to change
 * @param on  whether to enable or disable the feature
 *
 ...
 * @param adapter  the private adapter structure
 * @param eicr  the interrupt cause register value
 *
 ...
 * @param adapter  private adapter struct
 *
 ...
 * @param adapter  private network adapter structure
 *
 ...
 * @param work  pointer to the work struct
 *
 ...
 * @param q_vector  structure containing interrupt and ring information
 * @param skb  particular skb to send timestamp with
 *
 * if the timestamp is valid, we convert it into the timecounter ns
 * value, then store that result into the shhwtstamps structure which
 * is passed up the network stack
 ...
 * @param adapter  the private ixgbe adapter structure
 * @param config  the hwtstamp configuration requested
 *
...
/**
 * ixgbe_ptp_reset
 * @param adapter  the ixgbe private board structure
 *
 ...
 * @param adapter  the ixgbe private adapter structure
 *
