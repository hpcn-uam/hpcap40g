 ...
 * @param value  pointer to receive value read
 *
 * Returns status code
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param enable  enable or disable source address pruning
 * @param pool  Rx pool to set source address pruning for
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param ctrl  pointer to location to receive final IOSF control value
 *
 ...
 * @param device_type  3 bit device type
 ...
 * @param reg_addr  32 bit PHY register to write
 * @param device_type  3 bit device type
 * @param phy_data  Pointer to read data from the register
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param linear  true if SFP module is linear
 */
 ...
 * @param autoneg  true when autoneg or autotry is enabled
 */
 ...
 * @param hw  pointer to hardware structure
 * @param lsc  pointer to boolean flag which indicates whether external Base T
 ...
 * @param hw  pointer to hardware structure
 * @param speed  the link speed to force
 *
 ...
 * @param hw  address of hardware structure
 * @param link_up  address of boolean to indicate link status
 *
 ...
 * @param hw  point to hardware structure
 *
 ...
 * @param data  word(s) read from the EEPROM
 *
 ...
 * @param hw  pointer to hardware structure
 * @param ptr  pointer offset in eeprom
 * @param size  size of section pointed by ptr, if 0 first word will be used as size
 * @param csum  address of checksum to update
 *
 ...
 * @param hw  pointer to hardware structure
 * @param buffer  pointer to buffer containing calculated checksum
 ...
 * @param hw  pointer to hardware structure
 * @param lcd_speed  pointer to lowest common link speed
 *
 ...
 * @param hw  pointer to hardware structure
 * @param state  set mux if 1, clear if 0
 */
 ...
 * @param hw  pointer to hardware structure
 * @param led_idx  led number to turn on
 **/
 ...
 * @param hw  pointer to hardware structure
 * @param led_idx  led number to turn off
 **/
