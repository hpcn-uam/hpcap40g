...
#ifdef REMOVE_DUPS
#define FEATURE_DUPS "dup-removal "
#else
#define FEATURE_DUPS ""
#endif

#define DRV_VERSION "HPCAP " HPCAP_BUILD_INFO " " FEATURE_DUPS "IXGBE " IXGBE_BUILD_INFO
#else
