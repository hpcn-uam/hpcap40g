 ...
 * @param mbx_id id of mailbox to write
 *
 ...
 * @param hw pointer to the HW structure
 * @param mask bitmask for bits to be tested and cleared
 *
 ...
 * @param hw pointer to the HW structure
 * @param mbx_id id of mailbox to check
 *
 ...
 * @param msg The message buffer
 * @param size Length of buffer
 * @param mbx_id id of mailbox to read
 *
