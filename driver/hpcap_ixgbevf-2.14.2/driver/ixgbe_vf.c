 ...
 * @param mc_addr_list array of multicast addresses to program
 * @param mc_addr_count number of multicast addresses to program
 * @param next caller supplied function to return next address in list
 *
 ...
 * @param hw pointer to the HW structure
 * @param vlan 12 bit VLAN ID
 * @param vind unused by VF drivers
 * @param vlan_on if true then set bit, else clear bit
 **/
 ...
 * @param autoneg true if autonegotiation enabled
 ...
 * @param hw pointer to the HW structure
 * @param max_size value to assign to max frame size
 **/
 ...
 * @param hw pointer to the HW structure
 * @param api integer containing requested API version
 **/
