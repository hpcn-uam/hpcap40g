...
#define HPCAP_BUILD_INFO "no-info-present"
#endif

#define DRV_VERSION "HPCAP " HPCAP_BUILD_INFO " IXGBEVF 2.14.2"
 ...
 * @param q_vector board private structure
 ...
 * @param ring structure containig ring specific data
 ...
 * @param rx_ring rx descriptor ring (for a specific queue) to setup buffers on
 ...
 * @param data pointer to the start of the headers
 * @param max_len total length of section to find headers in
 *
 ...
 * @param irq unused
 * @param data pointer to our q_vector struct for this interrupt vector
 **/
 ...
 * @param adapter board private structure to initialize
 * @param v_idx index of vector in adapter struct
 *
 ...
 * @param adapter board private structure to clear interrupt scheme on
 *
 ...
 * @param ent entry in ixgbevf_pci_tbl
 * @returns 0 on success, negative on failure
 **/
								   ...
								   const struct pci_device_id *ent)
{
	...
	adapter->numa_node = cpu_to_node(adapter->core);
...
static int __init ixgbevf_init_module(void)
{
	...
	devs_found = hpcap_fix_iface_numbers(ixgbevf_pci_tbl);
