 ...
 * @param eee_cap value of the MMD EEE Capability register
 *
 ...
 * @param eee_adv value of the MMD EEE Advertisement/Link Partner Ability registers
 *
 ...
 * @param adv the ethtool advertisement settings
 *
...
#if defined(UTS_UBUNTU_RELEASE_ABI) && (LINUX_VERSION_CODE < KERNEL_VERSION(3,14,0))
...
#if ( !(RHEL_RELEASE_CODE && RHEL_RELEASE_CODE >= RHEL_RELEASE_VERSION(7,0)) ) && !defined(UTS_UBUNTU_RELEASE_ABI)
